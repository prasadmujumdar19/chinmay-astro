...
| WF-44 | Feedback Recorder | 🟢 Active | 🟡 P3 | n8n: "WF-44 Feedback Recorder" (Du2CJ3OTohRFZYoA) — was "WF-26 Feedback Recorder" | Captures user feedback text. Runs WF-25 intent classifier first: rebook_intent → WF-45 Rebook; all other intents → saves feedback to DB + sends ack via WF-50. Updated May 2026 (TD-032). |
| WF-45 | Rebook Handler | 🟢 Active | 🟠 P2 | n8n: "WF-45 Rebook Handler" (MUG7rPgSHc7UtAE9) | Handles REBOOK keyword or rebook_intent. Loads user record, sets status=payment_pending, sends interactive "Payment Completed" button with standard ₹500 UPI instructions (+91-9653240263, Chinmay Mujumdar). Updated May 2026 (TD-011): standard UPI text + interactive button. |
