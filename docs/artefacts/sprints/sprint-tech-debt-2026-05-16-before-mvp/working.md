...
> **Status:** ✅ Done — 2026-05-16 | WF-34 se82n3MUQ9xE5aEr | Added "Reset User Status to payment_pending" Postgres node after "Update Payment Record"
...
> **Status:** ✅ Done — 2026-05-16 | WF-01 hYGNM97sXvdo1WmI | Added "Send Non-Text Deflection via WF-50" node; Silent Reject (Message Type) now routes to WF-50
...
> **Status:** ⚪ Obsolete — 2026-05-16 | Accepted as-is. Phone-number-id is a non-sensitive routing identifier, not a credential, not expected to change. If WABA number ever changes, update the HTTP URL in WF-50 manually — one field, trivial. Env var approach adds VPS complexity without meaningful benefit.
...
**Fix:** Store the phone number ID as n8n environment variable `WA_PHONE_NUMBER_ID`. Reference via `{{ $env.WA_PHONE_NUMBER_ID }}` in the URL template node within WF-50.
...
> **Status:** ✅ Done — 2026-05-16 | WF-23 VpCER0Vqq3NYJGpI | Added stop_intent condition to Is Pass-Through Intent?; added Is Stop Intent? → Call WF-47 Unsubscribe on false branch
...
> **Status:** ✅ Done — 2026-05-16 | WF-44 Du2CJ3OTohRFZYoA | Inserted Is Stop Intent? → Call WF-47 Unsubscribe between Is Rebook Intent? false branch and Save Feedback to DB
...
> **Status:** ✅ Done — 2026-05-16 | WF-60 6H75p935FpBVBQtV | Deleted 5 dead legacy nodes (Inbound/Outbound Prepare Log Entry, Inbound/Outbound Log Message, Get User ID); active path intact
...
> **Status:** ✅ Done — 2026-05-16 | J-11 updated in user_journey_map.html; Design Rule 10 added to CLAUDE.md; WF-42 + WF-45 cross-refs added to workflow-registry.md
...
| TD-NEW-012 | WF-50 hardcoded Meta phone-number-id → env var | 🟡 P2 |
