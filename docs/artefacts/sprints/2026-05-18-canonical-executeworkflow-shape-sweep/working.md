...
- [x] **WF-12 Admin -> WhatsApp Relay** (`RjwHs9Dx5cK8Q5wD`) — 1 node: `Call WF-50 Send WhatsApp`
  > **Status:** ✅ Done — 2026-05-18 | 1 nodes rolled to canonical 1.2 shape | lint passed | live verified | backup: archive/backups/RjwHs9Dx5cK8Q5wD-2026-05-18-01-09.json
- [x] **WF-20 Keyword Handler** (`LgIDj1v4ZbCPlX25`) — 3 nodes: `Send HELP Response`, `Route to Rebook`, `Call WF-47 Unsubscribe`
  > **Status:** ✅ Done — 2026-05-18 | 3 nodes rolled to canonical 1.2 shape | lint passed | live verified | backup: archive/backups/LgIDj1v4ZbCPlX25-2026-05-18-01-09.json
- [x] **WF-23 Pre-Form Intent Filter** (`VpCER0Vqq3NYJGpI`) — 3 nodes: `Call WF-25 Intent Classifier`, `Re-send Flow Form via WF-50`, `Call WF-47 Unsubscribe`
  > **Status:** ✅ Done — 2026-05-18 | 3 nodes rolled to canonical 1.2 shape | lint passed | live verified | backup: archive/backups/VpCER0Vqq3NYJGpI-2026-05-18-01-09.json
- [x] **WF-25 Intent Classifier** (`eTV1lUcYrXBg2q2T`) — 4 nodes: `Send Garbage Warning`, `Notify Admin of Garbage`, `Send Block Warning`, `Auto-Block via WF-46`. **Critical-path workflow** (called by every free-form state handler). Verify with at least one free-form intent test post-fix.
  > **Status:** ✅ Done — 2026-05-18 | 4 nodes rolled tv=1.1 → 1.2 canonical shape | lint passed | live verified | backup: archive/backups/eTV1lUcYrXBg2q2T-2026-05-18-00-50.json
- [x] **WF-30 Payment Pending Intent Filter** (`gGJBY5fJha0Let8I`) — 3 nodes: `Call WF-25 Intent Classifier`, `Send Payment Reminder via WF-50`, `Call WF-47 Unsubscribe`
  > **Status:** ✅ Done — 2026-05-18 | 3 nodes rolled to canonical 1.2 shape | lint passed | live verified | backup: archive/backups/gGJBY5fJha0Let8I-2026-05-18-01-09.json
- [x] **WF-31 Payment Submitted Handler** (`HB8nXudAtk9iXz7C`) — 4 nodes: `Call WF-25 Intent Classifier`, `Send Under Review via WF-50`, `Relay to Admin Slack`, `Call WF-47 Unsubscribe`. **Blocking smoke test resume** — verify by sending free-form text from `61466927921` (current state = payment_submitted, waiting for admin approval).
  > **Status:** ✅ Done — 2026-05-18 | 4 nodes rolled tv=1.1 → 1.2 canonical shape | lint passed | live verified | backup: archive/backups/HB8nXudAtk9iXz7C-2026-05-18-00-48.json
- [x] **WF-40 User -> Admin Relay** (`du32QBZbSQOjfESe`) — 1 node: `Call WF-51 (Post to Slack)`
  > **Status:** ✅ Done — 2026-05-18 | 1 nodes rolled to canonical 1.2 shape | lint passed | live verified | backup: archive/backups/du32QBZbSQOjfESe-2026-05-18-01-09.json
- [x] **WF-44 Feedback Recorder** (`Du2CJ3OTohRFZYoA`) — 4 nodes: `Call WF-25 Intent Classifier`, `Call WF-45 Rebook`, `Send Ack via WF-50`, `Call WF-47 Unsubscribe`
  > **Status:** ✅ Done — 2026-05-18 | 4 nodes rolled to canonical 1.2 shape | lint passed | live verified | backup: archive/backups/Du2CJ3OTohRFZYoA-2026-05-18-01-09.json
- [x] **WF-45 Rebook Handler** (`MUG7rPgSHc7UtAE9`) — 1 node: `Send Payment Instructions`
  > **Status:** ✅ Done — 2026-05-18 | 1 nodes rolled to canonical 1.2 shape | lint passed | live verified | backup: archive/backups/MUG7rPgSHc7UtAE9-2026-05-18-01-09.json
- [x] **WF-47 Unsubscribe Handler** (`2U7mxHMyqA41ROKX`) — 2 nodes: `Send Hold Message via WF-50`, `Send Opt-out Confirmation via WF-50`. These are at tv=1.0 (older than the rest, also auto-bumps to 1.2 in roller).
  > **Status:** ✅ Done — 2026-05-18 | 2 nodes rolled to canonical 1.2 shape (tv=1.0 → 1.2) | lint passed | live verified | backup: archive/backups/2U7mxHMyqA41ROKX-2026-05-18-01-09.json
