...
Source-of-truth status (active/disabled) is in `docs/workflow-registry.md`. Generated 2026-06-05 from a live n8n export (post behavior-matrix-fixes Batch 1–9 builds; BMX-P5-DRIFT regen).
