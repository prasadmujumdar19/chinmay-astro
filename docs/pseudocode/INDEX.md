...
Source-of-truth status (active/disabled) is in `docs/workflow-registry.md`. Generated 2026-05-26 from a live n8n export (post canonical-executeworkflow-shape-sweep sprint).
